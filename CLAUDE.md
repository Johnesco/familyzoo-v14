# Family Zoo — v14 — Capability Dispatch — Claude Project Memory
...
**Name:** Family Zoo — v14 — Capability Dispatch
**Purpose:** Sharpee tutorial step 14 — Capability Dispatch.
...
**Repository:** https://github.com/Johnesco/familyzoo-v14
**Live:** https://johnesco.github.io/familyzoo-v14/
...
├── familyzoo-14.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v14.story`.
